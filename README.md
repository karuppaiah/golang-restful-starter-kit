...
[![GoDoc](https://godoc.org/github.com/karuppaiah/golang-restful-starter-kit?status.png)](http://godoc.org/github.com/karuppaiah/golang-restful-starter-kit)
[![Build Status](https://travis-ci.org/karuppaiah/golang-restful-starter-kit.svg?branch=master)](https://travis-ci.org/karuppaiah/golang-restful-starter-kit)
[![Coverage Status](https://coveralls.io/repos/github/karuppaiah/golang-restful-starter-kit/badge.svg?branch=master)](https://coveralls.io/github/karuppaiah/golang-restful-starter-kit?branch=master)
[![Go Report](https://goreportcard.com/badge/github.com/karuppaiah/golang-restful-starter-kit)](https://goreportcard.com/report/github.com/karuppaiah/golang-restful-starter-kit)
...
go get github.com/karuppaiah/golang-restful-starter-kit

# install dep
$ curl https://raw.githubusercontent.com/golang/dep/master/install.sh | sh

# fetch the dependent packages
cd $GOPATH/karuppaiah/golang-restful-starter-kit
dep ensure
```
...
`$GOPATH/karuppaiah/golang-restful-starter-kit` directory:
...
* move the directory `$GOPATH/github.com/karuppaiah/golang-restful-starter-kit` to `$GOPATH/github.com/abc/xyz`
* do a global replacement of the string `github.com/karuppaiah/golang-restful-starter-kit` in all of
